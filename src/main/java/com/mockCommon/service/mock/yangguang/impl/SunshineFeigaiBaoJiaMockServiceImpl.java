...
import com.mockCommon.model.mock.yangguang.SunshineFeigaiBaoJiaMockModel;
...
@Service("sunshineFeigaiBaoJiaMockServiceImpl")
public class SunshineFeigaiBaoJiaMockServiceImpl implements SunshineBaoJiaMockService {
	...
	@Autowired
	private IDataMaker<SunshineFeigaiBaoJiaMockModel> sunshineFeigaiBaoJiaFreeMarker;
	...
	public String baoJia(String xmlParams) {
		...
		SunshineFeigaiBaoJiaMockModel sunshineBaoJiaMockModel = new SunshineFeigaiBaoJiaMockModel();
		// 设置从请求中获得的参数
		...
		if (sunshineBaoJiaModel != null) {
			...
			if (sunshineBaoJiaModel.getCov_734() != null) {
				if (sunshineBaoJiaModel.getCov_734().equals("1")) {
					BusinessIni ini = iniMap.get("cov_734");
					if (ini != null) {
						String cov_734 = ini.getIniValue();
						baoJiaModel.setCov_734(cov_734);
						bizTotalPremium += Double.parseDouble(cov_734);
					}
					sunshineBaoJiaMockModel.setCov734Value("1");
					sunshineBaoJiaMockModel.setCov734Data("不投保:0;投保:1");
				} else if (sunshineBaoJiaModel.getCov_734().equals("0")) {
					baoJiaModel.setCov_734("0");
					sunshineBaoJiaMockModel.setCov734Value("0");
					sunshineBaoJiaMockModel.setCov734Data("不投保:0;投保:1");
				} else {
					sunshineBaoJiaMockModel.setCov734Value("0");
					sunshineBaoJiaMockModel.setCov734Data("不可投保:0");
				}
				// 设置修理期间费用补偿险的保额和天数
				BusinessIni ini = iniMap.get("cov_731");
				if(ini != null){
					baoJiaModel.setCov_731(ini.getIniValue());
					sunshineBaoJiaMockModel.setCov731Value("0");
				}else{
				...
				if(ini != null){
					...
					sunshineBaoJiaMockModel.setCov732Value("0");
				}else{
					baoJiaModel.setCov_732("0");
					sunshineBaoJiaMockModel.setCov732Value("0");
				}
			}
			if (sunshineBaoJiaModel.getCov_733() != null) {
				if (sunshineBaoJiaModel.getCov_733().equals("1")) {
					BusinessIni ini = iniMap.get("cov_733");
					if (ini != null) {
						String cov_733 = ini.getIniValue();
						baoJiaModel.setCov_733(cov_733);
						bizTotalPremium += Double.parseDouble(cov_733);
					}
					sunshineBaoJiaMockModel.setCov733Value("1");
					sunshineBaoJiaMockModel.setCov733Data("不投保:0;投保:1");
				} else if (sunshineBaoJiaModel.getCov_733().equals("0")) {
					baoJiaModel.setCov_733("0");
					sunshineBaoJiaMockModel.setCov733Value("0");
					sunshineBaoJiaMockModel.setCov733Data("不投保:0;投保:1");
				} else {
					sunshineBaoJiaMockModel.setCov733Value("0");
					sunshineBaoJiaMockModel.setCov733Data("不可投保:0");
				}
			}
		...
		// 生成最终返回数据
		String packageBody = sunshineFeigaiBaoJiaFreeMarker
				.generateData2output(ContextConstant.PREFIX_SUNSHINE_FEIGAI_BAOJIA,
						sunshineBaoJiaMockModel);
